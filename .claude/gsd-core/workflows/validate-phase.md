...
```
Agent(
  prompt="Read C:/Users/Gaski/Clockin/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Gaski/Clockin/.claude/gsd-core/templates/VALIDATION.md`

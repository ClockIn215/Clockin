...
<required_reading>
@C:/Users/Gaski/Clockin/.claude/gsd-core/references/user-story-template.md
@C:/Users/Gaski/Clockin/.claude/gsd-core/references/spidr-splitting.md
@C:/Users/Gaski/Clockin/.claude/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@C:/Users/Gaski/Clockin/.claude/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@C:/Users/Gaski/Clockin/.claude/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@C:/Users/Gaski/Clockin/.claude/gsd-core/references/spidr-splitting.md`. Briefly:

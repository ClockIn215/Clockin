...
<required_reading>
@C:/Users/Gaski/Clockin/.claude/gsd-core/references/domain-probes.md
@C:/Users/Gaski/Clockin/.claude/gsd-core/references/gate-prompts.md
@C:/Users/Gaski/Clockin/.claude/gsd-core/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "C:/Users/Gaski/Clockin/.claude/gsd-core/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@C:/Users/Gaski/Clockin/.claude/gsd-core/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:

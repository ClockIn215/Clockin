...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Users/Gaski/Clockin/.claude/.gsd-surface.json`
(sibling to `C:/Users/Gaski/Clockin/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Users/Gaski/Clockin/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/Users/Gaski/Clockin/.claude/skills`).
...
`C:/Users/Gaski/Clockin/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Users/Gaski/Clockin/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Users/Gaski/Clockin/.claude/.gsd-surface.json`
Install profile marker: `C:/Users/Gaski/Clockin/.claude/.gsd-profile`
Skill dirs: `C:/Users/Gaski/Clockin/.claude/skills/gsd-*/`
Engine module: `C:/Users/Gaski/Clockin/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/Users/Gaski/Clockin/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>

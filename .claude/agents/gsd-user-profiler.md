...
<reference>
@C:/Users/Gaski/Clockin/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Users/Gaski/Clockin/.claude/gsd-core/references/user-profiling.md` to load:
